...
(direction-elevation) heatmaps for hockey shot analysis. It reads angular heatmap
data generated by ``getAngularHeatmapsPerPlayer.py`` and produces side-by-side
visualizations showing how utility distributions transform between coordinate
systems.
...
Input Requirements
------------------
Expects angular heatmap data files in:
    Experiments/hockey-multi/{experimentFolder}/Data/AngularHeatmaps/
    
Files should follow the naming convention:
    angular_heatmap_data_player_{playerID}_type_shot_{typeShot}.pkl

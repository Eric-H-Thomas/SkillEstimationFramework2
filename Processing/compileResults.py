...
if __name__ == '__main__':
	...
	parser.add_argument("-folderContains", dest = "folderContains", help = "Name of folder containing the results of the experiments", type = str, default = "Experiment")
	parser.add_argument("-domain", dest = "domain", help = "Name of the domain.", type = str, default = "hockey-multi")
	parser.add_argument("-expFolder", dest = "expFolder", help = "Name of the experiment folder.", type = str, default = "Testing")
	args = parser.parse_args()


	mainFolder = f"Experiments{os.sep}{args.domain}{os.sep}{args.expFolder}{os.sep}"
	...
	# Filter experiments
	# Assumes folders with actual experiments have "folderContains" in their name
	# To ignore other folders
	for f in folders:

...
def main():
	...
	parser.add_argument("-domain", dest = "domain", help = "Specify which domain to use (1d/2d)", type = str, default = "baseball-multi")
	...
	# args.resultsFolder = f"Experiments-BaseballMulti-NumObservations{args.numObservations}-NumParticles{args.numParticles[0]}"

	args.resultsFolder = f"Experiment-PitcherID-{args.ids[0]}-PitchTypes-{args.types[0]}"
